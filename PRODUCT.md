...
- **Idiomas de trabajo: español e inglés** (Boris, 19 de septiembre de 2026): nadie del equipo trabaja con soltura en alemán. Por eso la web ya no dice «trabajamos en español, inglés y alemán» sino «en español e inglés», y la tercera cifra de las credenciales es «2 países · Equipo en Ecuador y Berlín» (antes, «3 idiomas de trabajo»). En alemán se dice así: «La primera conversación es en inglés. Su web se hace en alemán, y los textos los acordamos con usted». **La reunión de veinte minutos es en español o en inglés** (Boris, 19 de septiembre de 2026): Boris, en Berlín, hace las llamadas en inglés, no en alemán. Por eso la nota de los cierres dice «en español o inglés» en los tres idiomas, y en alemán el cierre dice con claridad que la primera conversación es en inglés. La web sí existe en alemán.
...
- **Trilingüe ES/EN/DE es obligatorio** y cada idioma es una URL real e indexable (`/es`, `/en`, `/de`). **Alcance por idioma (19 de septiembre de 2026):** inglés, todo el sitio; alemán, solo la línea digital y «Nosotros», con trato de *Sie*. Qué página existe en qué idioma se decide en un solo sitio, `cjm-nexus/src/i18n/rutas.mjs`; las que no existen redirigen a la más cercana. Estado (19 de septiembre de 2026): los tres idiomas escritos (`.impeccable/TRADUCCION.md`). **El idioma principal es el inglés** (Boris, 19 de septiembre de 2026): `cjmnexus.com` a secas lleva a `/en` y el x-default de los hreflang apunta a `/en`; `/es` y `/de` funcionan igual. Se publica en los tres idiomas, alemán incluido. Todo enlace interno lleva el idioma delante.
...
1. **El 50/50.** Dirección financiera y soluciones digitales pesan lo mismo donde aparezcan juntas: mismo tamaño, mismo tratamiento, misma duración. Cuando una tiene que ir primero, el orden lo marcan «Servicio 01» y «Servicio 02», y no cambia nada más.
   **Excepción escrita (Boris, 19 de septiembre de 2026): el alemán.** En alemán la web muestra solo la línea digital (soluciones digitales, portafolio) y «Nosotros», porque en Berlín la dirección financiera no se ofrece. Allí las dos líneas no aparecen juntas, así que el 50/50 no aplica. La dirección financiera solo se nombra en alemán en «Nosotros», en la línea de Richard, como servicio para clientes de Latinoamérica. El método, en alemán, solo con el ejemplo de software.
...
- **No hay ningún cliente de páginas web todavía.** Por eso no hay número ni testimonio en la página de soluciones digitales. Las pruebas son KLINODA, esta web y **el portafolio** (`/portafolio`, desde el 19 de septiembre de 2026): tres portadas de ejemplo para marcas ficticias de Berlín, en inglés, que se presentan siempre como conceptos, nunca como clientes. La página ya tiene el sitio evidente donde poner los clientes cuando lleguen.
